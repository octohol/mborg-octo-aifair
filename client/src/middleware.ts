 ...
 * 
 * This middleware intercepts requests to /api/ routes and forwards them
 * to the configured API server, allowing the frontend to proxy API calls.
 * 
 * @param context - Astro middleware context containing request information
